...
namespace OOADProject
{
    public class RJDatePicker : DateTimePicker
    {
        ...
        private Image calendarIcon = OOADProject.Properties.Resources.calendarWhite;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.6F)
                    calendarIcon = OOADProject.Properties.Resources.calendarDark;
                else calendarIcon = OOADProject.Properties.Resources.calendarWhite;
                this.Invalidate();
            }
        }
